...
enyo.requiresWindow(function() {
	if (window.PalmSystem) {
		//PalmSystem.stageReady();// removed it started to early to show the card loading animation.
		//enyo.appinfo = window.PalmSystem.getResource("appinfo.json", "const json"); poging om appinfo uit te lezen.
		enyo.webOS = {
			identifier: function(){
